 ...
 * Headers are configured with user name and password to communicate with SAP.
 * @class 
 */
export class DatawareServiceWithPassword {
    ...
    post(url: string, data: any): Promise<any> {
        return new Promise((resolve, reject) => {
            this.setHeaders();
                Axios.post(url, data, { headers: this.headers }).then(response => {
