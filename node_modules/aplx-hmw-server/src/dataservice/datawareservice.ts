         ...
         put(url: string, data: any, headers = {}): Promise<any> {
           return new Promise((resolve, reject) => {
             Axios.put(url, data, { headers: headers })
               ...
               .catch(err => {
                 let errResponse: any = { status: err.response.status, statusText: err.response.statusText, url: err.response.config.url, data: err.response.data };
