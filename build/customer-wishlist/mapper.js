...
var CustomerWishlistMapper = /** @class */ (function () {
    function CustomerWishlistMapper() {
    }
    /**
     ...
     */
    CustomerWishlistMapper.prototype.getWishlistItemListResponseMapper = function (data) {
        var response = [];
        if (data) {
    ...
    return CustomerWishlistMapper;
}());
exports.CustomerWishlistMapper = CustomerWishlistMapper;
